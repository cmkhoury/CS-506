...
CREATE TABLE Item(IID INTEGER PRIMARY KEY, Price REAL, SID INTEGER NOT NULL, DESCRIPTION TEXT, QUANTITY INTEGER, FOREIGN KEY(SID) REFERENCES Store(SID));
...
INSERT INTO Item(Price, SID, QUANTITY, DESCRIPTION) VALUES ('200', '1', '4', 'iPhone');
INSERT INTO Item(Price, SID, QUANTITY, DESCRIPTION) VALUES ('600', '1', '4', 'iPad');
INSERT INTO Item(Price, SID, QUANTITY, DESCRIPTION) VALUES ('800', '1', '4', 'Mac Pro');
INSERT INTO Item(Price, SID, QUANTITY, DESCRIPTION) VALUES ('200', '2', '4', 'Apple Watch');
INSERT INTO Item(Price, SID, QUANTITY, DESCRIPTION) VALUES ('400', '2', '4', 'Mac Mini');
INSERT INTO Item(Price, SID, QUANTITY, DESCRIPTION) VALUES ('600', '2', '4', 'iMac');
INSERT INTO Item(Price, SID, QUANTITY, DESCRIPTION) VALUES ('200', '3', '4', 'Apple Pencil');
INSERT INTO Item(Price, SID, QUANTITY, DESCRIPTION) VALUES ('400', '3', '4', 'MacBook Pro');
INSERT INTO Item(Price, SID, QUANTITY, DESCRIPTION) VALUES ('600', '3', '4', 'MacBook');
